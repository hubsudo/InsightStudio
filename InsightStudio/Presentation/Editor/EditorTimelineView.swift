...
final class EditorTimelineView: UIView {
    ...
    @objc private func handleLeftPan(_ gesture: UIPanGestureRecognizer) {
        ...
        layoutTimeline()
        delegate?.timelineView(self, didChange: startRatio, endRatio: endRatio, activeHandle: .left)
    }
    ...
    @objc private func handleRightPan(_ gesture: UIPanGestureRecognizer) {
        ...
        layoutTimeline()
        delegate?.timelineView(self, didChange: startRatio, endRatio: endRatio, activeHandle: .right)
    }
